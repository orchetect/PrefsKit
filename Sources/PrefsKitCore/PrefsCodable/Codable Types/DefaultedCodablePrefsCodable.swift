//
//  DefaultedCodablePrefsCodable.swift
...
/// > the same encoder/decoder, that you create a protocol that inherits from ``DefaultedCodablePrefsCodable``
...
public protocol DefaultedCodablePrefsCodable: CodablePrefsCodable, DefaultedPrefsCodable { }
